...
(function() {
    ...
    EXAMPLES.config = {
        ...
        'Search & geocoding': {
            ...
            'Polygons for geographies': 'polygons-for-geographies.html',
    ...
    EXAMPLES.descriptions = {
        ...
        'polygons-for-geographies.html': '<p>This example shows how to use Additional Data service to ' +
            'retrieve polygons representing administrative borders of a particular search result. For this reason ' +
            'search results were limited to Geographies only.</p><p>For more information please refer to the ' +
    ...
    EXAMPLES.load = function(exampleId) {
        ...
        CodepenLinkGenerator.prototype.getJavascriptCodeForCodepen = function(code, keys) {
            var generatedCode = code
                ...
                .replace(/<your-product-version>/g, '4.29.1-SNAPSHOT')
                .replace(/<your-product-name>/g, 'Codepen Examples')
                .replace(/<your-tomtom-sdk-base-path>/g, 'https://api.tomtom.com/maps-sdk-js/4.29.0/examples/sdk');

            if (generatedCode.match(/^\s*require\(\[.*/g)) {
                var requireConfig = {
                    baseUrl: 'https://api.tomtom.com/maps-sdk-js/4.29.0/examples'
                };
        ...
        function parseCode(response) {
            ...
            displayReponse = response.replace(/${api.key}/g, '<your-tomtom-API-key>')
                ...
                .replace(/4.29.1-SNAPSHOT/g, '<your-product-version>')
